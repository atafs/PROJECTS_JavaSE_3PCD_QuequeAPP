...
import dao.phonebook.interfaces.PhoneBook;
import dao.phonebook.list.PhoneBookMap;

public class PhoneBookTest {

	private PhoneBook contacts = (PhoneBook) new PhoneBookMap();
	...
	public void testAddEntry() {
		PhoneBook newContacts = (PhoneBook) new PhoneBookMap();
