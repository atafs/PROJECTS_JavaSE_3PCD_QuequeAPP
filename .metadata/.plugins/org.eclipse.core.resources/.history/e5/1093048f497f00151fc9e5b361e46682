...
/*     */     catch (Exception e)
/*     */     {
/*  47 */       Logger.getLogger(ServidorService.class.getName()).log(Level.SEVERE, null, e);
/*     */     }
/*     */   }
/*     */   
...
/*  65 */         Logger.getLogger(ServidorService.class.getName()).log(Level.SEVERE, null, ex);
/*     */       }
/*     */     }
/*     */     
/*     */ 
...
/*  79 */             boolean isConnected = ServidorService.this.connect(message, this.output);
/*     */             
/*  81 */             if (isConnected) {
/*  82 */               ServidorService.this.mapOnlies.put(message.getName(), this.output);
/*  83 */               ServidorService.this.sendOnlines();
/*     */             }
/*  85 */           } else { if (action.equals(ChatMessage.Action.DISCONNECT)) {
/*  86 */               ServidorService.this.disconnected(message, this.output);
/*  87 */               ServidorService.this.sendOnlines();
/*  88 */               return; }
/*  89 */             if (action.equals(ChatMessage.Action.SEND_ONE)) {
/*  90 */               ServidorService.this.sendOne(message);
/*     */ 
/*     */             }
/*  93 */             else if (action.equals(ChatMessage.Action.SEND_ALL)) {
/*  94 */               ServidorService.this.sendAll(message);
/*     */             }
/*     */           }
/*     */         }
/*     */       }
/*     */       catch (IOException ex)
/*     */       {
/* 101 */         ServidorService.this.disconnected(message, this.output);
/* 102 */         ServidorService.this.sendOnlines();
/* 103 */         System.out.println(message.getName() + " LEFT THE CHAT.");
/*     */       } catch (ClassNotFoundException ex) {
/* 105 */         Logger.getLogger(ServidorService.class.getName()).log(Level.SEVERE, null, ex);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */     } catch (IOException ex) {
/* 157 */       Logger.getLogger(ServidorService.class.getName()).log(Level.SEVERE, null, ex);
/*     */     }
/*     */   }
/*     */   
...
/*     */         } catch (IOException ex) {
/* 169 */           Logger.getLogger(ServidorService.class.getName()).log(Level.SEVERE, null, ex);
/*     */         }
/*     */       }
/*     */     }
/*     */   }
...
/*     */         } catch (IOException ex) {
/* 187 */           Logger.getLogger(ServidorService.class.getName()).log(Level.SEVERE, null, ex);
/*     */         }
/*     */       }
/*     */     }
/*     */   }
...
/*     */       } catch (IOException ex) {
/* 210 */         Logger.getLogger(ServidorService.class.getName()).log(Level.SEVERE, null, ex);
/*     */       }
/*     */     }
/*     */   }
/*     */ }
